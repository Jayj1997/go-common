...
func TestRedBlackTree(t *testing.T) {
	...
	if actualValue := tree.Size(); actualValue != 7 {
		t.Errorf("Got %d expected %d", actualValue, 7)
	}
...
func BenchmarkRedBlackTreeInsert100(b *testing.B) {
	b.StopTimer()
	size := 100
	tree := NewWithIntComparator()
	b.StartTimer()
...
func BenchmarkRedBlackTreeInsert1000(b *testing.B) {
	b.StopTimer()
	size := 1000
	tree := NewWithIntComparator()
	for n := 0; n < size; n++ {
...
func BenchmarkRedBlackTreeInsert10000(b *testing.B) {
	b.StopTimer()
	size := 10000
	tree := NewWithIntComparator()
	for n := 0; n < size; n++ {
